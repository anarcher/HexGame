...
${OBJECTDIR}/HexGraph.o: HexGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HexGraph.o HexGraph.cpp
...
${OBJECTDIR}/NegaMax.o: NegaMax.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/NegaMax.o NegaMax.cpp

${OBJECTDIR}/HexBoard.o: HexBoard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HexBoard.o HexBoard.cpp

${OBJECTDIR}/_ext/155446752/MonteCarlo.o: /cygdrive/C/Users/Koy/Dropbox/Ass5/MonteCarlo.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/155446752
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/155446752/MonteCarlo.o /cygdrive/C/Users/Koy/Dropbox/Ass5/MonteCarlo.cpp
